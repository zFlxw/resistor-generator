<script lang="ts">
  import { Color, EReihe, getResistanceFromColors } from '$lib/scripts/helper';
  import Dropdown from '$lib/components/Dropdown.svelte';
  import { resistance } from '$lib/stores/ResistanceStore';
  import {
    firstRingColor,
    secondRingColor,
    thirdRingColor,
  } from '$lib/stores/RingColorStore';
  import {
    firstRingDropdownOpen,
    secondRingDropdownOpen,
    thirdRingDropdownOpen,
  } from '$lib/stores/DropdownStore';
  import { isImprintModalOpen } from '$lib/stores/ModalStore';
  import Modal from '$lib/components/Modal.svelte';

  let eReihen: string | any[] = [];
